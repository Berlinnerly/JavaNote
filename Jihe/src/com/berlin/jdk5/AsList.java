...
//        demo2();
        ...
        String[] arr = list.toArray(new String[10]);        //当集合转换数组时，数组的长度如果是小于等于集合的size()时，转换后的数组长度等于集合的size
                                                            //如果数组的长度大于了size分配的数组长度就和你指定的长度一样
    ...
    public static void demo2() {
        //        int[] arr = {11,22,33,44,55};     基本数据类型的数组转集合，会将整个数组当作一个对象转换
